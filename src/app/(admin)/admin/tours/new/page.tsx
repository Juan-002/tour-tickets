...
import { CreateTourDTO } from "@/types";

const EMPTY_FORM: CreateTourDTO = {
  title: "", description: "", price: 0,
  imageUrl: "", totalSlots: 0, location: "", duration: "",
};
...
export default function NewTourPage() {
  ...
  const [form, setForm]              = useState<CreateTourDTO>(EMPTY_FORM);
