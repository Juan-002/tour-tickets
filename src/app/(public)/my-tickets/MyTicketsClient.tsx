        ...
        {!loading && !error && tickets.length > 0 && (
          <div className="grid grid-cols-3 gap-5 mb-12">
            {[
              ...
              <div key={s.label} className="bg-white/[0.03] border border-white/[0.07] p-6 flex items-center gap-5 hover:border-[#C4903E]/20 transition-colors">
                <div className="w-11 h-11 border border-[#C4903E]/25 flex items-center justify-center shrink-0">{s.icon}</div>
                <div>
...
function LogoutButton() {
  ...
  return (
    <button onClick={handleLogout} className="font-sans text-xs tracking-widest uppercase transition-colors text-white/30 hover:text-red-400">
      Salir
    </button>
  );
}