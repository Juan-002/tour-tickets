      ...
      <div className="grain bg-mesh">
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 680, flex: 1 }}>
            ...
            <h1 className="font-display anim-fade-up-2" style={{
              ...
              lineHeight: 1.0, fontWeight: 900, marginBottom: 32,
            }}>
              Aventuras<br />
            ...
            <p className="font-body anim-fade-up-3" style={{
              ...
              color: 'rgba(245,237,216,0.65)', maxWidth: 480, marginBottom: 48,
            }}>
              Reserva tus tiquetes para los tours más increíbles.
              Experiencias únicas, cupos limitados, recuerdos para toda la vida.
            </p>

            <div className="anim-fade-up-4" style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            ...
            <div className="anim-fade-in" style={{
              ...
              gap: 32, marginTop: 80, maxWidth: 480,
            }}>
              {[
                ...
                <div className="stat-card" key={s.label}>
                  <p className="font-display" style={{ fontSize: '2rem', fontWeight: 700, color: '#C4903E' }}>
                    {s.value}
                  </p>
                  <p className="font-body" style={{
                    fontSize: '0.78rem', color: 'rgba(245,237,216,0.5)',
          ...
          <div className="anim-fade-in" style={{
            ...
            <div className="tour-card float-card">
              <div style={{
                ...
                <div style={{
                  ...
                  backgroundImage: 'radial-gradient(ellipse at 30% 40%, rgba(196,144,62,0.2), transparent 60%)',
                }} />
                ...
                <div style={{
                  ...
                  background: '#C4903E', color: '#0D1B0F',
              ...
              <div style={{ padding: '20px 20px 24px' }}>
                <p style={{
                  fontSize: '0.7rem', letterSpacing: '0.2em', color: '#C4903E',
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <p style={{ fontSize: '0.7rem', color: 'rgba(245,237,216,0.4)', fontFamily: "'DM Sans', sans-serif" }}>
                      desde
                    </p>
                    <p className="font-display" style={{ fontSize: '1.5rem', fontWeight: 700, color: '#C4903E' }}>
                      $1'500.000
                    </p>
                  </div>
                  <a href="/tours" style={{
                    background: 'rgba(196,144,62,0.15)',
                    border: '1px solid rgba(196,144,62,0.3)',
                    color: '#C4903E', padding: '8px 16px',
            ...
            <div style={{
              ...
              width: 280, height: 280, background: '#162018',
              border: '1px solid rgba(196,144,62,0.12)',
          ...
          <div style={{
            ...
            <p style={{
              ...
              color: 'rgba(245,237,216,0.35)', fontFamily: "'DM Sans', sans-serif",
            }}>
              SCROLL
            </p>
        ...
        <section style={{ padding: '100px 60px', maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <h2 className="font-display" style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: 700, lineHeight: 1.2 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
            {[
              {
                icon: (
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C4903E" strokeWidth="1.5">
              ...
              <div className="feature-card" key={f.title}>
                <div style={{
                  width: 56, height: 56,
                  border: '1px solid rgba(196,144,62,0.25)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: 24,
                }}>
                  {f.icon}
                </div>
                <h3 className="font-display" style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: 12 }}>
                  {f.title}
                </h3>
                <p className="font-body" style={{ fontSize: '0.9rem', color: 'rgba(245,237,216,0.55)', lineHeight: 1.7 }}>
                  {f.desc}
                </p>
              </div>
            ))}
        ...
        <section style={{ padding: '0 60px 120px' }}>
          <div style={{
            ...
            <div>
              ...
              <h2 className="font-display" style={{ fontSize: 'clamp(1.75rem, 3.5vw, 2.75rem)', fontWeight: 700, lineHeight: 1.2 }}>
